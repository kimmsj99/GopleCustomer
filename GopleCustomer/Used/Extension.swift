...
extension UIViewController {
    ...
    func showToast(message : String) {
        ...
        let toastLabel = UILabel(frame: CGRect(x: 0, y: self.view.frame.size.height - 100, width: 200, height: 35))
        toastLabel.center.x = self.view.frame.width / 2
        toastLabel.backgroundColor = UIColor.black.withAlphaComponent(0.6)
        toastLabel.textColor = UIColor.white
        toastLabel.textAlignment = .center;
        toastLabel.font = UIFont(name: "Daehan-Bold", size: 14.0)
